...
public partial class ProbeControlWindow : Window
{
    ...
    {
        RaiseCommandTextBox.Text = string.IsNullOrWhiteSpace(_settings.RaiseCommand) ? "$J=G91 Z-10 F5000" : _settings.RaiseCommand;
        DropCommandTextBox.Text = string.IsNullOrWhiteSpace(_settings.DropCommand) ? "$J=G91 Z10 F5000" : _settings.DropCommand;
